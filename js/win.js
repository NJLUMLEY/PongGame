var winState = {
  ...
  create: function() {
    ...
    if (game.global.P1Score >= game.global.P2Score) {
      game.global.WinnerPlayer = 1;
    } else if (game.global.P1Score <= game.global.P2Score){
      game.global.WinnerPlayer = 2;
    }

    winLabel = game.add.text(80, 80, 'Congratulations Player ' + game.global.WinnerPlayer, {font: '50px Arial', fill: '#00ff00'});

    //Show the player their final score
   scoreLabelOne = game.add.text(game.world.centerX-250, game.world.centerY, 'Player 1: ' + game.global.P1Score, {font: '45px Arial', fill: '#00ff00'});
//   scoreLabelOne.anchor.setTo(0.5, 0.5);

   scoreLabelTwo = game.add.text(game.world.centerX+60, game.world.centerY, 'Player 2: ' + game.global.P2Score, {font: '45px Arial', fill: '#00ff00'});
